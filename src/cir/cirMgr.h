...
{
public:
   CirMgr(): _maxVarIdx(0), _const(0), _simLog(0), _fecGrps(0) {}
   ...
   void topoCalSim();
   void randomSim();
   void simulate(size_t);
   void fileSim(ifstream&);
   void fraigSim(vector<string>&);
   bool setPiSim(string&, size_t);
   void setSimResult();
   ...
   bool checkPair(SatSolver&, size_t, size_t);
   bool checkGrp(SatSolver&, FecGrp&, vector<string>&);
   void fraig();
...
private:
   ...
   unordered_map<HashKey, CirGate*, HashString> _gateHashTable;
};
